...
# patterns = create_training_data("./data/computer_science_glossary.json","CS_TERM")
# generate_rules(patterns)


nlp = spacy.load("cs_ner")

doc = nlp("What is object oriented programming?")

for ent in doc.ents:
    print(ent.label_ ,"<->",ent.text )
# clean_up_data("./data/computer_science_glossary.json")
